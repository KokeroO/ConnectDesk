...
ActiveRecord::Schema[7.0].define(version: 2024_09_23_215335) do
  ...
  create_table "chatwoot.access_tokens", force: :cascade do |t|
    t.string "owner_type"
    t.bigint "owner_id"
    t.string "token"
  ...
  create_table "chatwoot.account_users", force: :cascade do |t|
    t.bigint "account_id"
    t.bigint "user_id"
  ...
  create_table "chatwoot.accounts", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.action_mailbox_inbound_emails", force: :cascade do |t|
  ...
  create_table "chatwoot.active_storage_attachments", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "chatwoot.active_storage_blobs", force: :cascade do |t|
  ...
  create_table "chatwoot.active_storage_variant_records", force: :cascade do |t|
    t.bigint "blob_id", null: false
    t.string "variation_digest", null: false
    t.index ["blob_id", "variation_digest"], name: "index_active_storage_variant_records_uniqueness", unique: true
  end

  create_table "chatwoot.agent_bot_inboxes", force: :cascade do |t|
    t.integer "inbox_id"
  ...
  create_table "chatwoot.agent_bots", force: :cascade do |t|
    t.string "name"
  ...
  create_table "chatwoot.applied_slas", force: :cascade do |t|
  ...
  create_table "chatwoot.articles", force: :cascade do |t|
  ...
  create_table "chatwoot.attachments", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.audits", force: :cascade do |t|
  ...
  create_table "chatwoot.automation_rules", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
    t.text "description"
  ...
  create_table "chatwoot.campaigns", force: :cascade do |t|
  ...
  create_table "chatwoot.canned_responses", id: :serial, force: :cascade do |t|
    t.integer "account_id", null: false
    t.string "short_code"
    t.text "content"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "chatwoot.categories", force: :cascade do |t|
    t.integer "account_id", null: false
    t.integer "portal_id", null: false
    t.string "name"
    t.text "description"
  ...
  create_table "chatwoot.channel_api", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.channel_email", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.channel_facebook_pages", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.channel_line", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.channel_sms", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.channel_telegram", force: :cascade do |t|
    t.string "bot_name"
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.channel_twilio_sms", force: :cascade do |t|
  ...
  create_table "chatwoot.channel_twitter_profiles", force: :cascade do |t|
  ...
  create_table "chatwoot.channel_web_widgets", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.channel_whatsapp", force: :cascade do |t|
    t.integer "account_id", null: false
    t.string "phone_number", null: false
    t.string "provider", default: "default"
    t.jsonb "provider_config", default: {}
  ...
  create_table "chatwoot.contact_inboxes", force: :cascade do |t|
    t.bigint "contact_id"
    t.bigint "inbox_id"
  ...
  create_table "chatwoot.contacts", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.conversation_participants", force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "chatwoot.conversations", id: :serial, force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.csat_survey_responses", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "conversation_id", null: false
  ...
  create_table "chatwoot.custom_attribute_definitions", force: :cascade do |t|
  ...
  create_table "chatwoot.custom_filters", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "chatwoot.custom_roles", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.bigint "account_id", null: false
  ...
  create_table "chatwoot.dashboard_apps", force: :cascade do |t|
    t.string "title", null: false
  ...
  create_table "chatwoot.data_imports", force: :cascade do |t|
    t.bigint "account_id", null: false
  ...
  create_table "chatwoot.email_templates", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "chatwoot.folders", force: :cascade do |t|
    t.integer "account_id", null: false
  ...
  create_table "chatwoot.inbox_members", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.inboxes", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.installation_configs", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "chatwoot.integrations_hooks", force: :cascade do |t|
  ...
  create_table "chatwoot.labels", force: :cascade do |t|
    t.string "title"
    t.text "description"
  ...
  create_table "chatwoot.macros", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.string "name", null: false
  ...
  create_table "chatwoot.mentions", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "conversation_id", null: false
    t.bigint "account_id", null: false
  ...
  create_table "chatwoot.messages", id: :serial, force: :cascade do |t|
    t.text "content"
    t.integer "account_id", null: false
    t.integer "inbox_id", null: false
  ...
  create_table "chatwoot.notes", force: :cascade do |t|
  ...
  create_table "chatwoot.notification_settings", force: :cascade do |t|
    t.integer "account_id"
    t.integer "user_id"
  ...
  create_table "chatwoot.notification_subscriptions", force: :cascade do |t|
    t.bigint "user_id", null: false
  ...
  create_table "chatwoot.notifications", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "user_id", null: false
  ...
  create_table "chatwoot.platform_app_permissibles", force: :cascade do |t|
  ...
  create_table "chatwoot.platform_apps", force: :cascade do |t|
    t.string "name", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "chatwoot.portal_members", force: :cascade do |t|
    t.bigint "portal_id"
    t.bigint "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "chatwoot.portals", force: :cascade do |t|
    t.integer "account_id", null: false
    t.string "name", null: false
    t.string "slug", null: false
  ...
  create_table "chatwoot.portals_members", id: false, force: :cascade do |t|
  ...
  create_table "chatwoot.related_categories", force: :cascade do |t|
  ...
  create_table "chatwoot.reporting_events", force: :cascade do |t|
    t.string "name"
    t.float "value"
    t.integer "account_id"
    t.integer "inbox_id"
  ...
  create_table "chatwoot.sla_events", force: :cascade do |t|
  ...
  create_table "chatwoot.sla_policies", force: :cascade do |t|
    t.string "name", null: false
  ...
  create_table "chatwoot.taggings", id: :serial, force: :cascade do |t|
    t.integer "tag_id"
  ...
  create_table "chatwoot.tags", id: :serial, force: :cascade do |t|
    t.string "name"
  ...
  create_table "chatwoot.team_members", force: :cascade do |t|
  ...
  create_table "chatwoot.teams", force: :cascade do |t|
    t.string "name", null: false
    t.text "description"
  ...
  create_table "chatwoot.telegram_bots", id: :serial, force: :cascade do |t|
    t.string "name"
    t.string "auth_key"
    t.integer "account_id"
    t.datetime "created_at", precision: nil, null: false
  ...
  create_table "chatwoot.users", id: :serial, force: :cascade do |t|
  ...
  create_table "chatwoot.webhooks", force: :cascade do |t|
    t.integer "account_id"
    t.integer "inbox_id"
    t.string "url"
    t.datetime "created_at", null: false
  ...
  create_table "chatwoot.working_hours", force: :cascade do |t|
    t.bigint "inbox_id"
    t.bigint "account_id"
